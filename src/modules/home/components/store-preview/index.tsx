    ...
    <section className="main-store-preview-container max-w-screen-xl">
      ...
      <div className="relative min-h-[30vh] h-full max-h-[35vh] min-w-[400px] max-w-screen-xl 2xl:max-w-screen-2xl">
        ...
        <div className="w-full overflow-hidden">
          <Image draggable={false} className="w-full h-full object-cover" src={"/from_side_xl.jpg"} quality="100" alt="store preview image" width={0} height={0} sizes="fill" style={{ width: '100%', height: 'auto', minHeight: '30vh' }} />
        </div>
      </div>
