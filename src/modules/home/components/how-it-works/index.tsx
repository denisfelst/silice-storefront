...
const HowItWorks = () => {
  return (
    <section className="how-it-works-container w-full max-w-screen-xl bg-gray-50 p-8 rounded-sm shadow-lg mb-4 md:mx-4">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0">
          <div className="relative flex flex-col items-center text-center bg-white rounded-sm shadow-lg p-6 flex-1 min-w-[250px] max-w-[300px] min-h-[200px]">
          ...
          <div className="relative flex flex-col items-center text-center bg-white rounded-sm shadow-lg p-6 flex-1 min-w-[250px] max-w-[300px] min-h-[200px]">
            <div className="w-12 h-12 bg-[#87c4ef] text-white rounded-full flex items-center justify-center mb-4">
