...
const Benefits = () => {
  return (
    <section className="main-benefits-container flex flex-col md:flex-row w-screen-xl max-w-screen-xl w-full p-6 space-y-6 md:space-y-0 md:space-x-6">
      {/* Benefit Card 1 */}
      <div className="relative w-full bg-gradient-to-br from-blue-500 to-teal-500 rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
        <Image
        ...
        <div className="relative flex flex-col justify-center items-center text-center w-full h-full p-6 text-white font-medium z-10">
      ...
      {/* Benefit Card 2 */}
      <div className="relative w-full bg-gradient-to-br from-green-500 to-lime-500 rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
        <Image
          src="/taller2.jpg"
          alt="Artisan process"
          width={0}
      ...
      {/* Benefit Card 3 */}
      <div className="relative w-full bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl">
        <Image
          src="/glass3.jpg"
          alt="Custom keyboard"
          width={0}
