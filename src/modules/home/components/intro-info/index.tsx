...
const IntroInfo = () => {
  return (
    <section className="info-section max-w-screen-xl bg-white p-8 text-center border border-gray-200 rounded-md shadow-sm my-2 mx-2 md:mx-4">
      <Heading
        level="h2"
      ...
      <div className="border-t-2 border-[#87c4ef] mx-auto w-24 my-4"></div>
